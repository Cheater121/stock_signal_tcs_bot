...
@bot.message_handler(commands=['stop'], is_chat_admin=True)
...
@bot.message_handler(commands=['status'], is_chat_admin=True)
...
@bot.message_handler(commands=['help'], is_chat_admin=True)
